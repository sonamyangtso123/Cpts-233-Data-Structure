...
public class DuplicatesResult {
    ...
    public boolean is_correct_dups() {
        ...
        // Compare both lists element by element for equality, quit if there's a
        // difference
    ...
    public void printOut(Boolean verbose) {
        ...
        System.out.println(" Expected duplicates: " + ground_truth_duplicates.size() + " | Found duplicates: "
                + duplicates_count());
        if (verbose == true) {
