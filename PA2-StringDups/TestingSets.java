 ...
 *
 *  [this file]: Vectors with duplicates to test
 * 
 *  Contributors:
...
// Main object to get full set of testing stringss and their duplicates
class TestingSets {
  public NoDupsTestSet noDups;
  public SuperShortTestSet superShort;
  public SmallTestSet small;
  public OneHundredTestSet oneHundred;
  public OneThousandTestSet oneThousand;
  public ArrayList<TestSetBase> allSets = new ArrayList<TestSetBase>();

  public TestingSets() {
    noDups = new NoDupsTestSet();
    superShort = new SuperShortTestSet();
    small = new SmallTestSet();
    oneHundred = new OneHundredTestSet();
    oneThousand = new OneThousandTestSet();
    allSets.add(noDups);
    allSets.add(superShort);
    allSets.add(small);
    allSets.add(oneHundred);
    allSets.add(oneThousand);
  }
}


// A single pair of stringss to test an algorithm against
// Contains the full strings (with duplicates) and a vector for the solution
class TestSetBase {
  public String name = "Base Class";
  public ArrayList<String> strings = new ArrayList<String>();
  public ArrayList<String> dups = new ArrayList<String>();
}

class NoDupsTestSet extends TestSetBase {
  public NoDupsTestSet() {
    name = "No Dups";
    strings = new ArrayList<String>(
      Arrays.asList("one", "two", "three", "four", "five", "six", "seven", "done"));
    dups = new ArrayList<String>(
      Arrays.asList());
  }
}

class SuperShortTestSet extends TestSetBase {
  public SuperShortTestSet() {
    name = "Super Short";
    strings = new ArrayList<String>(
...
class SmallTestSet extends TestSetBase {
  public SmallTestSet() {
    name = "Small";
    strings = new ArrayList<String>(
      Arrays.asList("one", "two", "three", "four", "five", "six", "one", "seven", "one", "two", "three", "done"));
    dups = new ArrayList<String>(
      Arrays.asList("one", "two", "three"));
  }
}

class OneHundredTestSet extends TestSetBase {
  public OneHundredTestSet() {
    name = "One Hundred";
    strings = new ArrayList<String>(
      Arrays.asList(
...
class OneThousandTestSet extends TestSetBase {
  public OneThousandTestSet() {
    name = "One Thousand";
    strings = new ArrayList<String>(
      Arrays.asList(
